...
<div
	class="flex h-full w-full flex-col rounded-r-lg px-1 pt-3 text-gray-200"
	style="height: 87vh; background: linear-gradient(170deg, #3b0764 30%, #712da4);"
>
	<!-- Projects Section -->
	<div
		class="flex flex-1 flex-col overflow-y-auto px-5"
		style="min-height: 40%; max-height: 40%; max-width:100%;"
	>
		<ul class="menu mb-2 w-full">
			<li class="menu-title w-full text-xl text-purple-100">I tuoi progetti</li>
	...
	<div class="my-2 flex justify-center">
		<button
			...
			on:click={() => create_project_form.showModal()}>+</button
		>
	</div>

	<!-- Separator Line -->
	<div class="my-4 border-t border-purple-900"></div>
