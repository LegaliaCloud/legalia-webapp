...
<section class="relative" style="height:100vh">
	...
	<div class="centered card z-20 w-96 bg-white text-black shadow-xl">
		<div class="card-body">
			<h2 class="text-center text-xl font-bold">Login</h2>
			<div role="alert" class="alert-vertical sm:alert-horizontal alert bg-purple-950 text-white">
				<div>
				...
				<a
					href="/#demo"
					class="btn btn-sm border-green-500 bg-green-500 text-white hover:border-green-400 hover:bg-green-400"
					>Invia</a
				>
			</div>
			{#if err != ''}
			...
			<div class="card-actions justify-center">
				<button on:click={authenticate} class="btn bg-purple-950 capitalize text-white"
					>Login</button
				>
			</div>
		</div>
